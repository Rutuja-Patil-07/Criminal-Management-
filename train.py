...
class Train:
	def __init__(self,root):
		...
		lbl_title=Label(self.root,text='TRAIN DATA SET',font=('times new roman',35,'bold'),bg='white',fg='red')
		lbl_title.place(x=0,y=0,width=1530,height=45)

		#top image
		img_top=Image.open(r"images/f1.webp")
		...
		#bottom image
		img_bottom=Image.open(r"images/f2.png")
